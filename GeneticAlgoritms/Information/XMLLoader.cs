        ...
        public Plate Parse()
        {
            ...
            foreach (XElement el in resourse.Root.Elements())
            {
                ...
                _Segments.Add(new Segment(Convert.ToInt32(el.Attribute("id").Value),
                                                              Convert.ToInt32(point_01.Attribute("x").Value),
                                                              Convert.ToInt32(point_01.Attribute("y").Value),
                                                              Convert.ToInt32(point_02.Attribute("x").Value),
                                                              Convert.ToInt32(point_02.Attribute("y").Value),
