...
namespace GeneticAlgorithms
{
    public class Crosser
    {
        ...
        public static void OrderedCrossover(Iindividual _parent1, Iindividual _parent2, Iindividual _child)
        {
			Plate parent1 = _parent1 as Plate;
			Plate parent2 = _parent2 as Plate;
			Plate child = _child as Plate;
        ...
        public static void CyclicCrossover(Iindividual _parent1, Iindividual _parent2, Iindividual _child)
        {
			Plate parent1 = _parent1 as Plate;
			Plate parent2 = _parent2 as Plate;
			Plate child = _child as Plate;
